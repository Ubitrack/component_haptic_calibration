 ...
 */
UTHAPTICS_EXPORT Math::Matrix< float, 3, 4 > computePhantomLMGimbalCalibration( const std::vector< Math::Vector< float, 3 > > & jointangles, const std::vector< Math::Vector< float, 3 > > & gimbalangles,
                                                                               const std::vector< Math::Vector< float, 3 > > & zref, const float l1, const float l2,
                                                                               const Math::Matrix< float, 3 , 4 > angle_correction, Math::Vector< float, 3 > & calib );

UTHAPTICS_EXPORT Math::Matrix< double, 3, 4 > computePhantomLMGimbalCalibration( const std::vector< Math::Vector< double, 3 > > & jointangles, const std::vector< Math::Vector< double, 3 > > & gimbalangles,
                                                                                const std::vector< Math::Vector< double, 3 > > & zref, const double l1, const double l2,
                                                                                const Math::Matrix< double, 3 , 4 > angle_correction, Math::Vector< double, 3 > & calib );
